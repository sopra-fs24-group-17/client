...
const PasswordForgotten = () => {
  ...
  const doRequestPassword = async () => {
    ...
    try {
      ...
      alert(`Something went wrong during the reset: \n${handleError(error)}`);
  ...
  return (
    <Layout>
      <Container maxWidth="sm">
        ...
        <p>
          Enter your email address and username to reset your password. If there
          exists a user with these credentials, you will receive a one-time
          password
        </p>
