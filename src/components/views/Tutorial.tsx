    ...
    return (
        <Container maxWidth={false} sx={{ mt: 2 }}>
            <Grid container direction="column" spacing={2}>
                ...
                {/* insert picture of game state with a few players */}
                ...
                <Typography variant="h5" sx={{ mt: 3, mb: 2 }}>Cards</Typography> {/* Increased bottom margin here */}
                    ...
                    {[
                        ...
                        <Grid item xs={6} key={card.alt}>
                            <Grid container spacing={1} alignItems="center">
                                <Grid item xs={5}>
                                    <img src={card.src} alt={card.alt} style={{ width: '100px', height: 'auto' }} />
                                </Grid>
