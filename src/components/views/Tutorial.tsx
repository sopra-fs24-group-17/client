    ...
    <Container maxWidth={false} sx={{ mt: 2 }}>
      <Grid container direction="column" spacing={2}>
        ...
        <Typography variant="body1">
          This is a card game of risk, strategy, and luck, designed for 2-5
          players. Each player draws cards until someone draws an explosion
          card, which knocks them out of the game unless they have a defuse
          card. Before drawing a card, players can choose to play any number of
          their cards to manipulate the deck or affect other players. Drawing a
          card ends a player&#39;s turn. The goal is to win the game by being
        ...
        <Typography variant="body1">
          Five random cards (out of all cards except explosion and defuse cards)
          as well as one defuse card are dealt to each player. The remaining
          defuse and explosion cards are inserted back into the deck such that
          there&#39;s one fewer explosion card than the number of players. The
          deck is then shuffled and placed face-down in the center.
        </Typography>
        ...
        <Grid container spacing={2}>
          {[
            ...
            },
            {
              src: chicken,
              alt: "explosion",
              text: "If you draw this card, you are out! The only way to counteract this is by playing a defuse card (see below).",
            },
            {
              src: defuse,
              alt: "defuse-1",
            ...
            },
            {
              src: seethefuture,
              alt: "seethefuture-1",
              text: "Play this card to peek at the top two cards from the deck.",
            },
            {
              src: shuffle,
              alt: "shuffle-1",
              text: "The shuffle card simply shuffles the deck once.",
            },
            {
              src: skip,
              alt: "skip-1",
              text: "This card instantly ends your turn without having to draw a card. Other than that, it has no additional functionality.",
            },
            {
              src: favor,
              alt: "favor-1",
              text: "Force a player of your choice to give you a random card.",
            },
          ].map((card, index) => (
